  ...
  useEffect(() => {
    const submit = async () => {
      try {
        ...
        const res = await axios.post("https://ai-interview-platform-2-z5e3.onrender.com/api/interview/submit", payload);
        setResult(res.data);
...
//     const submit = async () => {
//       try {
//         const res = await axios.post("https://ai-interview-platform-2-z5e3.onrender.com/api/interview/submit", {
